...
const ALLOWED_DIRECTORY = process.env.ALLOWED_DIRECTORY ??
    (() => {
...
server.tool("write_file", "Write content to a file, creating it if it doesn't exist", {
...
server.tool("list_files", "List files and directories in a given path", {
    path: z
        .string()
        .optional()
